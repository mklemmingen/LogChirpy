...
\begin{itemize}
    ...
    \item Map component implementation for bird sighting geolocation visualization
...
\begin{itemize}
    ...
    \item Internationalization and localization support implementation
    \item User interface text optimization and enhancement
    \item Design feedback provision and usability assessment
\end{itemize}

\subsubsection{Technical Implementation Contributions}
\begin{itemize}
    \item Initial wireframe creation for development visualization at project initiation
    \item Translation key development for common error handling (20 of 600 translation lines)
    \item Design feedback provision for user interface components
    \item Usability testing protocols and improvement recommendations
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Usability Assessment:} User experience evaluation, design feedback frameworks
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Total Contribution: ~9 hours}
\end{itemize}
...
\hline
Project Initialization & Week 1-2 & Martin \\
Firebase Integration & Week 3-4 & Luis \\
ML Pipeline Development & Week 5-8 & Martin \\
UI/UX Implementation & Week 6-10 & Martin, Youmna \\
Testing and Optimization & Week 9-11 & Martin, Luis \\
Documentation Completion & Week 12 & All Team Members \\
\hline
\end{tabular}
...
\subsubsection{Youmna Samouneh}
\begin{itemize}
    \item \textbf{Design Process Understanding:} Experience in UI/UX design for mobile application development
    \item \textbf{Internationalization Expertise:} Understanding of international application development considerations
    \item \textbf{Team Communication Skills:} Importance of design feedback and user perspective integration
\end{itemize}
...
\begin{itemize}
    \item \textbf{Prof. Dr. Arjan Kuijper:} Academic supervision and technical guidance provision
    \item \textbf{Hochschule RheinMain:} Development environment and institutional support provision
