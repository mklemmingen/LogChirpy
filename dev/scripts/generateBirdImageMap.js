...
async function generateBirdImageMap() {
    console.log('🐦 Generating Bird Image Map...');
    ...
    try {
        ...
        console.log(`📝 Generated requires: ${Object.keys(imageMap).length}`);
        ...
        console.error('❌ Error generating bird image map:', error.message);
        process.exit(1);
    }
}
