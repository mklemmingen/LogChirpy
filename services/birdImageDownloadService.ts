...
const BIRD_ZIP_URLS = [
  ...
  'https://github.com/mklemmingen/LogChirpy/raw/main/assets/images/birds/_birds3.zip',
  'https://github.com/mklemmingen/LogChirpy/raw/main/assets/images/birds/_birds4.zip',
  'https://github.com/mklemmingen/LogChirpy/raw/main/assets/images/birds/_birds5.zip',
  'https://github.com/mklemmingen/LogChirpy/raw/main/assets/images/birds/_birds6.zip'
];
  ...
  private async downloadAndExtractZips(
    ...
    try {
      ...
      for (let i = 0; i < BIRD_ZIP_URLS.length; i++) {
        ...
        // Extract ZIP file
        await unzip(zipPath, BIRD_IMAGES_DIR);
  ...
  async downloadAllImages(
    ...
    try {
      ...
      if (progress) {
        ...
        console.log(`Downloaded ${progress.downloadedImages} bird images successfully`);
      }
      onComplete?.();
